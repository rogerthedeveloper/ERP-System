...
public function hacerDevolucion($table, $data, $data_detalle) {
    ...
    public function sendMailCierre() {
        ...
        try {
            ...
            $mail->addAddress('rogerthedeveloper@gmail.com', 'Roger Sosa');     // Add a recipient
            $mail->addAddress('tonyvaliente@gmail.com', 'Tony Valiente');     // Add a recipient
            $mail->addAddress('bcalderonf18@gmail.com', 'Byron Calderon');     // Add a recipient
