    ...
    <div class="col-md-<?php if($options["photo"] == true) { echo "8"; } else { echo "12"; } ?>">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input id="<?php echo $value[0]; ?>" value="<?php if($value[0] == "tipoMovimiento") { echo "Compra"; } ?>" placeholder="<?php echo strtoupper($value[0]); ?>" type="text" class="<?php if($value[1] == "date") { echo "datepicker"; } ?> form-control" placeholder="<?php echo strtoupper($value[0]); ?>" aria-describedby="basic-addon" <?php if($value[5] == "auto_increment") { echo "disabled"; } ?>>
            </div>
            ...
            <br>
                ...
                <div style="text-align: center;">
                    ...
                    <button id="new" type="button" class="new btn btn-success btn-md">
                        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Limpiar
                    </button>
